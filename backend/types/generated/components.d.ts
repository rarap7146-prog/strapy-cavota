...
export interface MediaAsset extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<['feature_image', 'image', 'video']>;
  };
}
...
export interface SectionsHero extends Struct.ComponentSchema {
  ...
  attributes: {
    ...
    media_mobile: Schema.Attribute.Media<'images'>;
    media_web: Schema.Attribute.Media<'images'>;
...
export interface SectionsProofBar extends Struct.ComponentSchema {
  ...
  info: {
    description: 'Proof bar with title and nested items containing logos and notes';
    displayName: 'Proof Bar';
  };
  attributes: {
    items: Schema.Attribute.Component<'ui.proof-item', true>;
...
export interface UiProofItem extends Struct.ComponentSchema {
  collectionName: 'components_ui_proof_items';
  info: {
    description: 'Individual proof item with logos and note';
